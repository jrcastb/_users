...
public class JasyptEncryptorConfig {
    ...
    private static final String ENCRYPTION_PASSWORD = System.getenv("JASYPT_ENCRYPTION_PASSWORD") != null
            ? System.getenv("JASYPT_ENCRYPTION_PASSWORD")
            : "defaultPassword";
    ...
    public static PooledPBEStringEncryptor passwordEncryptor() {
        try {
